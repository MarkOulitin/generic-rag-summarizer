...
def main():
    ...
    parser.add_argument('--skip-collection', action='store_true', help='Skip document collection step')
    parser.add_argument('--skip-processing', action='store_true', help='Skip document processing step')
    parser.add_argument('--skip-embeddings', action='store_true', help='Skip embedding generation step')
    parser.add_argument('--step', choices=['collection', 'processing', 'embeddings'], help='Run only a specific step')
